/**
 * Zelula403 — ayarlanabilir damla kırmızı taşlı zirkon halka detaylı altın kaplama yüzük
 *   node scripts/import-zelula403-damla-zirkon-yuzuk.mjs
 */
...
const PRODUCT = {
  slug: "scarlet-drop-ayarlanabilir-damla-zirkon-altin-kaplama-yuzuk",
  name: "Scarlet Drop Ayarlanabilir Damla Zirkon Taşlı Altın Kaplama Yüzük",
  color: "Altın / Kırmızı",
  material: "Sağlam Altın Kaplama Alaşım",
  short:
    "Damla kesim koyu kırmızı merkez taş ve yanlarda zirkon kaplı halka detayları. Ayarlanabilir altın kaplama yüzük; modern ve cesur bir statement parça.",
  full: `Ortada damla (pear) formunda koyu kırmızı merkez taş, altın kaplama bezel içinde öne çıkar. Yan taraflarda pürüzsüz altın silindir geçişler ve zirkon taşlarla kaplı halka detayları bir arada; altın–gümüş ton karışımı modern bir kontrast oluşturur.

Kalın, yuvarlak profilli bant ayarlanabilir açık yapıdadır; farklı parmak ölçülerine kolay uyum sağlar. Sağlam altın kaplama alaşım gövde günlük kullanıma uygun parlak bir finish sunar.

Özellikler:
• Materyal: Sağlam altın kaplama alaşım
• Taş: Parlak zirkon taşlar + damla form koyu kırmızı merkez taş
• Tip: Ayarlanabilir yüzük
• Kargo: 350₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula403-1edf4f1a-81fb-4de5-af6e-6007511cce5a.png",
  ],
};
