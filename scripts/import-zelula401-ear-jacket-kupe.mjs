/**
 * Zelula401 — 2 parçalı zirkon ear jacket küpe
 *   node scripts/import-zelula401-ear-jacket-kupe.mjs
 *   node scripts/import-zelula401-ear-jacket-kupe.mjs --dry-run
 */
...
const PRODUCT = {
  slug: "luna-veil-2-parcali-zirkon-ear-jacket-kupe",
  name: "Luna Veil 2 Parçalı Baget Zirkon Taşlı Altın Ear Jacket Küpe",
  color: "Altın",
  material: "Paslanmaz Çelik",
  short:
    "İki parçalı ear jacket küpe: önde kalkan form zirkon stud, arkada üç yelpaze baget zirkon panel. Altın kaplama 316L çelik; stud tek başına da kullanılabilir.",
  full: `İki parçalı ear jacket tasarım; ön tarafta kalkan form baget zirkon taşlı stud, kulak arkasında ise üç kademeli yelpaze panel ile lobu çerçeveleyen dramatik bir siluet sunar. Her panelde baget kesim merkez taş ve üstünde üçlü mikro pavé zirkon detayı yer alır.

316L paslanmaz çelik altın kaplama gövde parlak ve dayanıklıdır. Stud parçayı tek başına minimal küpe olarak, jacket parçayla birlikte ise gece daveti ve özel gün kombinlerinde statement parça olarak kullanabilirsiniz.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın kaplama görünüm)
• Taş: Baget kesim zirkon + mikro pavé detay
• Tip: 2 parçalı ear jacket küpe — çift
• Kullanım: Stud tek başına veya set halinde
• Kargo: 350₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula401-4ced968b-6b2d-40ca-89bb-fdc45c1d9575.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula401_2_-2fd1d257-9256-4391-93d9-d368b6d0c2c1.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula401_3_-9076ba77-4a53-4e6a-9bf0-f929921a3eb9.png",
  ],
};
