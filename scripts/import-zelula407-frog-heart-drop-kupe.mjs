/**
 * Zelula407 — kurbağa + nazar kalp + baget zirkon sallantılı çelik küpe (çift)
 *   node scripts/import-zelula407-frog-heart-drop-kupe.mjs
 */
...
const PRODUCT = {
  slug: "nocturne-fauna-baget-zirkon-gumus-celik-sallantili-kupe",
  name: "Nocturne Fauna Baget Zirkon Taşlı Gümüş Renk Çelik Sallantılı Küpe",
  color: "Gümüş / Altın detay",
  material: "Paslanmaz Çelik",
  short:
    "Pavé zirkon kurbağa, nazar detaylı kalp ve baget kesim damla taşlı üç katmanlı sallantı. Gümüş renk 316L çelik küpe çifti — statement parça.",
  full: `Stud üstte pavé zirkon kaplı kurbağa figürü; altın tonlu ayak ve el detaylarıyla whimsical bir açılış sunar. Orta halkada nazar motifli kalp formu ve baget zirkon taşlarla çevrili bağlantılar, altta emerald-cut baget zirkon damla ile uzun sallantıyı tamamlar.

316L paslanmaz çelik gümüş renk gövde hipoalerjeniktir; gündüzden geceye maksimalist ve sembolik bir ışıltı arayanlar için tasarlanmıştır. Klipsli stud oturumu kulakta dengeli durur.

Özellikler:
• Materyal: 316L paslanmaz çelik (gümüş renk, altın detay)
• Taş: Pavé ve baget kesim parlak zirkon
• Tip: Sallantılı küpe — çift
• Kargo: 650₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_24_Tem_2026_01_41_34-803e3535-fd8e-477f-883d-19b1c3a50eb2.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_24_Tem_2026_01_40_33-90d1554c-cda2-45f1-80f7-218614037b61.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_24_Tem_2026_01_41_29-be5778fa-0035-4fe4-9bba-19fb7eb3f511.png",
  ],
};
