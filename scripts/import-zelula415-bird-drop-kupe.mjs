/**
 * Zelula415 — pavé zirkon kuş figürlü altın sallantılı küpe (çift)
 *   node scripts/import-zelula415-bird-drop-kupe.mjs
 */
...
const PRODUCT = {
  slug: "aves-radiance-pave-kus-altin-sallantili-kupe",
  name: "Aves Radiance Pavé Zirkon Kuş Figürlü Altın Kaplama Sallantılı Küpe",
  color: "Altın / Antrasit",
  material: "Paslanmaz Çelik",
  short:
    "Dokulu altın küre stud’dan sarkan pavé zirkon kanatlı kuş formu. 316L çelik statement küpe çifti — gündüzden geceye cesur ışıltı.",
  full: `Üstte dokulu (çekiçlenmiş) altın renk küre stud; küçük halka bağlantıyla kanatlarını açmış kuş figürü sallanır. Kuşun gövdesi parlak altın kaplama; kanat ve kuyruk antrasit zemin üzerinde pavé zirkon taşlarla kaplıdır. Statement siluet hem plaj hem gece kombinlerinde dikkat çeker.

316L paslanmaz çelik altın kaplama gövde hipoalerjeniktir; klipsli stud oturumu kulakta dengeli durur. Tek parça statement küpe arayanlar için tasarlanmış çift üründür.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın kaplama görünüm)
• Taş: Pavé zirkon (kanat & kuyruk)
...
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_9_A_u_2026_22_33_33-8c337e7d-ffd6-48e5-bd5a-990a305a3886.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_9_A_u_2026_23_00_50-f4105050-6607-4967-a1dc-eb48660076b7.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_9_A_u_2026_22_55_38-1426998b-e9e7-4522-8410-d6ca7ec09e51.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_9_A_u_2026_22_53_13-4ac340d9-96f0-48a3-8f68-207945d7ee88.png",
  ],
};
