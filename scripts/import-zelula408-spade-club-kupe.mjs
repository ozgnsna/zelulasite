/**
 * Zelula408 — maça + sinek zirkon sallantılı altın çelik küpe (çift)
 *   node scripts/import-zelula408-spade-club-kupe.mjs
 */
...
const PRODUCT = {
  slug: "royal-suit-spade-club-zirkon-altin-celik-sallantili-kupe",
  name: "Royal Suit Maça & Sinek Zirkon Taşlı Altın Kaplama Çelik Küpe",
  color: "Altın / Siyah-Beyaz",
  material: "Paslanmaz Çelik",
  short:
    "Pavé zirkon maça ve siyah taşlı sinek formu iki katmanlı sallantı. Altın renk 316L çelik küpe çifti — iskambil motifli statement parça.",
  full: `Stud üstte pavé zirkon taşlarla kaplı maça (spade) formu; altın kaplama halka ile sallanan sinek (club) formu siyah pavé taşlarla tamamlanır. İki katmanlı iskambil silueti gündüzden geceye cesur ve oyunbaz bir ışıltı sunar.

316L paslanmaz çelik altın renk gövde hipoalerjeniktir; klipsli stud oturumu kulakta dengeli durur. Tek parça kombinlerde bile dikkat çeken, koleksiyoner ruhlu bir küpe çiftidir.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın kaplama görünüm)
• Taş: Parlak zirkon (maça) + siyah pavé taş (sinek)
• Tip: Sallantılı küpe — çift
• Kargo: 650₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_24_Tem_2026_16_19_07-77053fd4-f83d-44bd-9b03-c1ae01c8207a.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_24_Tem_2026_16_23_02-b0d7dcba-17e2-4f86-9652-27dd3bd42358.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_24_Tem_2026_16_37_41-9518043c-7194-4717-b989-37ea54da1e0b.png",
  ],
};
