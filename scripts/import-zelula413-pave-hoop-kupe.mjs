/**
 * Zelula413 — pavé zirkon altın halka küpe (çift)
 *   node scripts/import-zelula413-pave-hoop-kupe.mjs
 */
...
const PRODUCT = {
  slug: "radiant-arc-pave-zirkon-altin-halka-kupe",
  name: "Radiant Arc Pavé Zirkon Taşlı Altın Kaplama Halka Küpe",
  color: "Altın",
  material: "Paslanmaz Çelik",
  short:
    "Üç sıra pavé zirkon taşla kaplı kalın altın halka küpe. 316L çelik menteşeli kilit — gündüzden geceye ışıltılı ve zarif.",
  full: `Kalın tube halka form; dış yüzeyde üç sıra pavé zirkon taş ve alt kısımda düz altın bant detayı. Menteşeli kilitli halka yapısı kulakta güvenli oturur; tek parça kombinlerde bile dikkat çeken parlak bir ışıltı sunar.

316L paslanmaz çelik altın kaplama gövde hipoalerjeniktir. Günlük, ofis ve özel gün kombinlerine uyumlu klasik halka küpe çiftidir.
...
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_17_02_48-3e1a22af-df96-4f74-ac95-1a5a25ce297c.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_17_14_34-9c490834-7968-4983-98b0-1a1ecc9fdfb6.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_17_45_24-74ae13c1-490f-42fa-97a9-5ce389365dd7.png",
  ],
};
