/**
 * Zelula402 — ayarlanabilir zirkon taşlı zümrüt yeşili merkez taşlı altın kaplama yüzük
 *   node scripts/import-zelula402-zirkon-yuzuk.mjs
 *   node scripts/import-zelula402-zirkon-yuzuk.mjs --dry-run
 */
...
const TRENDYOL_ATTRIBUTES = [
  { attributeId: 49, attributeValueId: 1209967 },
  ...
  { attributeId: 338, attributeValueId: 19253 },
  { attributeId: 343, attributeValueId: 4295 },
  { attributeId: 287, attributeValueId: 2738 },
  { attributeId: 1192, attributeValueId: 10617300 },
];

const PRODUCT = {
  slug: "verde-crown-ayarlanabilir-zirkon-altin-kaplama-yuzuk",
  name: "Verde Crown Ayarlanabilir Zirkon Taşlı Altın Kaplama Yüzük",
  color: "Altın / Zümrüt Yeşili",
  material: "Sağlam Altın Kaplama Alaşım",
  short:
    "Koyu zümrüt yeşili merkez taş etrafında çok sıra zirkon taşlı taç detayı. Ayarlanabilir altın kaplama yüzük; günlükten davete ışıltılı statement parça.",
  full: `Dikdörtgen zümrüt yeşili merkez taş, etrafında konsantrik sıralar halinde pavé zirkon taşlarla taç/halo formunda çevrelenir. Yan bantlarda üç paralel şerit zirkon kaplamasıyla yüzük hem lüks hem modern bir signet etkisi sunar.
...
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula402_2_-112497af-1194-41e6-a50f-d925178bdfa1.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula402-7b8e24ac-cf12-4237-926f-743d7f26171c.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula402_3_-8a73a108-66d4-4d40-90f2-653e3735beea.png",
  ],
};
...
async function run() {
  ...
  const { data: category } = await admin.from("categories").select("id").eq("slug", "yuzuk").maybeSingle();
  if (!category?.id) throw new Error("Yüzük kategorisi bulunamadı");
