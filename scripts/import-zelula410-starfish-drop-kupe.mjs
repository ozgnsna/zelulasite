/**
 * Zelula410 — pavé deniz yıldızı sallantılı altın çelik küpe (çift)
 *   node scripts/import-zelula410-starfish-drop-kupe.mjs
 */
...
const PRODUCT = {
  slug: "coastal-star-pave-deniz-yildizi-zirkon-altin-celik-sallantili-kupe",
  name: "Coastal Star Pavé Deniz Yıldızı Zirkon Altın Kaplama Çelik Sallantılı Küpe",
  color: "Altın / Siyah-Beyaz",
  material: "Paslanmaz Çelik",
  short:
    "Pavé zirkon deniz yıldızı formu, kol kollarında siyah taş detaylı yıldız silueti. Altın renk 316L çelik sallantılı küpe çifti — yaz ve plaj stiline uygun statement parça.",
  full: `Dokulu altın kaplama stud üzerinden sallanan beş kollu deniz yıldızı formu; parlak zirkon taşlarla kaplı yüzeyde her kolun ortasında siyah pavé taşlarla tamamlanan yıldız deseni dikkat çeker. Marin temalı, yaz kombinlerine ışıltılı ve anlamlı bir dokunuş katar.

316L paslanmaz çelik altın renk gövde hipoalerjeniktir; klipsli stud oturumu kulakta dengeli durur. Tek parça plaj elbisesi veya sade günlük kombinlerde bile öne çıkan bir küpe çiftidir.
...
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_15_46_46-c9807e03-54aa-413c-b57e-af67d3b53019.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_15_42_22-8822c3ed-ef39-4efd-8a90-76e84185f2c2.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_15_46_23-31ff1ee2-1ce9-45e7-ab91-619e8b9f9014.png",
  ],
};
