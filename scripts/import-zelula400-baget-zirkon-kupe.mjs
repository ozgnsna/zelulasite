/**
 * Zelula400 — baget zirkon taç detaylı altın oval küpe (çift)
 *   node scripts/import-zelula400-baget-zirkon-kupe.mjs
 *   node scripts/import-zelula400-baget-zirkon-kupe.mjs --dry-run
 */
...
const PRODUCT = {
  slug: "solstice-crown-baget-zirkon-altin-oval-kupe",
  name: "Solstice Crown Baget Zirkon Taşlı Altın Kaplama Oval Küpe",
  color: "Altın",
  material: "Paslanmaz Çelik",
  short:
    "Parlak altın oval gövde üzerinde beş baget zirkon taşlı taç detayı. 316L çelik stud küpe çifti; günlükten davete zarif ışıltı.",
  full: `Yumuşak oval siluetli altın kaplama gövde, üst kısımda beş baget kesim zirkon taştan oluşan taç/yelpaze detayıyla tamamlanır. Taşlar radyal dizilimle ışığı kırarak Art Deco esintili modern bir parlaklık sunar.

316L paslanmaz çelik altyapı hipoalerjeniktir; pimli stud oturumu kulakta dengeli durur. Tek başına statement parça olarak hem günlük kombinlerde hem akşam davetlerinde kullanılabilir.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın kaplama görünüm)
• Taş: Baget kesim parlak zirkon (taç detay)
• Tip: Stud küpe — çift
• Kargo: 350₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula400-c1116f81-b142-4d3c-81ef-c1c9c21d7b36.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula400_2_-62a798e4-d8de-49f7-a8fd-5b959bae50c2.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula400_3_-fc061cb5-6593-4d82-81be-11929fd2b9a3.png",
  ],
};
