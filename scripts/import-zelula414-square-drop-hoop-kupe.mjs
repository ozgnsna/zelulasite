/**
 * Zelula414 — kare baget zirkon sallantılı altın halka küpe (çift)
 *   node scripts/import-zelula414-square-drop-hoop-kupe.mjs
 */
...
const PRODUCT = {
  slug: "prism-drop-kare-zirkon-altin-halka-kupe",
  name: "Prism Drop Kare Zirkon Taşlı Altın Kaplama Halka Küpe",
  color: "Altın",
  material: "Paslanmaz Çelik",
  short:
    "Kalın altın halkadan sallanan kare kesim zirkon taş. 316L çelik huggie küpe çifti — ofis ve gece kombinlerine net ışıltı.",
  full: `Parlak altın kaplama kalın halka form; dört pençe tutuculu kare kesim zirkon taş halkadan aşağı sallanır. Huggie oturumu kulakta dengeli durur; tek taş detayı sade ama dikkat çeken bir siluet oluşturur.

316L paslanmaz çelik altın kaplama gövde hipoalerjeniktir. Günlük, ofis ve özel gün kombinlerine uyumlu modern halka küpe çiftidir.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın kaplama görünüm)
• Taş: Kare kesim parlak zirkon
• Tip: Halka / huggie küpe — çift
• Kargo: 650₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_18_27_07-4d992874-ac05-4d6b-91b5-e470a95c1e9b.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_19_16_25-2cc8e2f7-06a4-4232-87f3-ce5eb51526d0.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_19_16_59-ad570bc9-8e64-49cb-bda4-65bab3eba96f.png",
  ],
};
