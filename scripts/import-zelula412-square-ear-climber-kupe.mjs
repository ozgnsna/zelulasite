/**
 * Zelula412 — üçlü kare pavé zirkon ear climber altın küpe (çift)
 *   node scripts/import-zelula412-square-ear-climber-kupe.mjs
 */
...
const PRODUCT = {
  slug: "lumen-stack-uclu-kare-pave-zirkon-altin-ear-climber-kupe",
  name: "Lumen Stack Üçlü Kare Pavé Zirkon Altın Kaplama Ear Climber Küpe",
  color: "Altın",
  material: "Paslanmaz Çelik",
  short:
    "Üç kare pavé zirkon modülü kulak hattını yukarı taşıyan ear climber siluet. Altın kaplama 316L çelik küpe çifti — minimal ve ışıltılı günlük parça.",
  full: `Yumuşak köşeli üç kare form; her birinde pavé zirkon taşlarla kaplı merkez ve altın renk ince çerçeve. Ear climber oturumu kulak kenarında yukarı doğru uzanan modern bir çizgi oluşturur; tek stud ile takılır, üç modül birlikte hareket eder.

316L paslanmaz çelik altın kaplama gövde hipoalerjeniktir. Ofis, günlük ve akşam kombinlerinde sade ama dikkat çeken bir ışıltı sunar.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın kaplama görünüm)
• Taş: Pavé zirkon
• Tip: Ear climber küpe — çift
• Kargo: 650₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_16_06_17-bbea1c6f-22a1-46df-ac81-3824afad5bd9.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_16_47_47-63b227ae-1d68-49c9-a7c4-4ba51c6a9f6b.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_16_52_14-4824b43f-9b53-446d-9683-3acd2807c92d.png",
  ],
};
