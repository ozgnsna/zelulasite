/**
 * Zelula411 — kaplumbağa + baget zirkon sallantılı altın-gümüş çelik küpe (çift)
 *   node scripts/import-zelula411-turtle-baget-drop-kupe.mjs
 */
...
const PRODUCT = {
  slug: "turtle-tide-baget-zirkon-altin-gumus-celik-sallantili-kupe",
  name: "Turtle Tide Baget Zirkon Taşlı Altın & Gümüş Renk Çelik Sallantılı Küpe",
  color: "Altın / Gümüş",
  material: "Paslanmaz Çelik",
  short:
    "Pavé zirkon kaplumbağa stud ve altın çerçeveli baget kesim damla taşlı iki katmanlı sallantı. Altın-gümüş tonlu 316L çelik küpe çifti — marin temalı statement parça.",
  full: `Stud üstte pavé zirkon taşlarla kaplı kaplumbağa figürü; gümüş tonlu gövde ve altın halka bağlantı ile sallanan baget kesim parlak zirkon damla taş, yaz ve akşam kombinlerine lüks bir ışıltı katar.

316L paslanmaz çelik altın-gümüş iki tonlu gövde hipoalerjeniktir; klipsli stud oturumu kulakta dengeli durur. Deniz ve tatil stiline uygun, koleksiyoner ruhlu bir küpe çiftidir.

Özellikler:
• Materyal: 316L paslanmaz çelik (altın & gümüş kaplama görünüm)
• Taş: Pavé zirkon + baget kesim parlak zirkon
• Tip: Sallantılı küpe — çift
• Kargo: 650₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_15_49_35-83eaf603-0cae-40c8-a5c4-dba902d0d7cb.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_15_55_44-428908d5-3e3c-43eb-8484-5f6904ec4d46.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_25_Tem_2026_15_56_48-3efff856-90c0-45ac-800d-de551c2e0f35.png",
  ],
};
