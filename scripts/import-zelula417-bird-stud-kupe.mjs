/**
 * Zelula417 — pavé zirkon kuş form gümüş stud küpe (çift)
 *   node scripts/import-zelula417-bird-stud-kupe.mjs
 */
...
const PRODUCT = {
  slug: "aves-crown-pave-zirkon-gumus-kus-stud-kupe",
  name: "Aves Crown Pavé Zirkon Gümüş Renk Kuş Stud Küpe",
  color: "Gümüş / Altın detay",
  material: "Paslanmaz Çelik",
  short:
    "Pavé zirkon kaplı kuş formu, altın renk taç detayı ve siyah taş göz. 316L çelik stud küpe çifti — hafif ve ışıltılı.",
  full: `Gümüş renk gövdede pavé zirkon taşlarla kaplı kuş silueti; başta küçük altın renk taç/crest ve siyah taş göz detayı tamamlar. Aşağı doğru açılan tüy formları kulakta dengeli bir stud oturumu sunar — günlük ve tatil kombinlerine uyumlu hafif statement parçadır.

316L paslanmaz çelik gümüş renk gövde hipoalerjeniktir; klipsli stud gün boyu rahat durur. Tek başına veya set halinde kullanılabilir çift küpedir.

Özellikler:
• Materyal: 316L paslanmaz çelik (gümüş renk, altın detay)
• Taş: Pavé zirkon + siyah göz taşı
• Tip: Stud küpe — çift
• Kargo: 650₺ üzeri ücretsiz
• İade: 14 gün koşulsuz ücretsiz iade
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_11_A_u_2026_21_41_18-2dbcea44-d4e1-4c9e-b49b-2628984710fd.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_11_A_u_2026_21_40_57-7c92347a-fb6d-45a3-a325-e3f367520e0c.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_11_A_u_2026_21_38_02-1b86e64c-effb-42a5-b32e-5bf88b1305d3.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_ChatGPT_Image_11_A_u_2026_21_39_39-520b2e85-b12a-47a1-ac2c-d250e212026e.png",
  ],
};
