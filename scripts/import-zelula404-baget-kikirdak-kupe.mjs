/**
 * Zelula404 — baget zirkon iç içe form kıkırdak küpe (ear cuff)
 *   node scripts/import-zelula404-baget-kikirdak-kupe.mjs
 */
...
const PRODUCT = {
  slug: "celestia-link-baget-zirkon-altin-kaplama-kikirdak-kupe",
  name: "Celestia Link Baget Zirkon Taşlı Altın Kaplama Kıkırdak Küpe",
  color: "Altın",
  material: "Sağlam Altın Kaplama Alaşım",
  short:
    "İç içe geçen çift eğri form üzerinde baget kesim zirkon taşlar. Sıkıştırmalı altın kaplama kıkırdak küpe; helix ve kulak kenarında zarif statement ışıltı.",
  full: `İç içe geçen çift eğri siluet, baget kesim zirkon taşlarla kanal set edilerek kaplanır; altın kaplama yüzeyde lüks ve modern bir parlaklık oluşturur. Kompakt formu kulak kıkırdağında (helix) veya kulak kenarında ear cuff olarak kullanılabilir.

Sıkıştırmalı açık bant yapısı deliksiz takım sağlar; hafif baskı ile kulakta sabit durur. Sağlam altın kaplama alaşım gövde günlük kombinlerden akşam davetlerine kadar tek parçayla ışıltı katar.

Özellikler:
• Materyal: Sağlam altın kaplama alaşım
• Taş: Baget kesim parlak zirkon
...
• Özel hediye kutusunda gönderilir`,
  images: [
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula404-38d7c291-6f8f-4589-be1b-9582cde053d0.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula404_2_-21c8eab1-eb2c-456e-a1ec-f8433f009c34.png",
    "c__Users_ozgun_AppData_Roaming_Cursor_User_workspaceStorage_420a7a4f1dbc57494cb0d50a403fc873_images_Zelula404_3_-033af861-17d7-4e2b-9e97-b6612896e9b0.png",
  ],
};
